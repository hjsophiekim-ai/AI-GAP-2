#!/usr/bin/env python
"""READ-ONLY 60-business-day A/B/C replay comparing the Trend Establishment
Gate (TEG, scripts/teg_gate.py) against existing production TW2 -- 2026-08-27
사용자 요청. Never touches app/trading/macd2 production code.
...
import scripts.teg_gate as teg  # noqa: E402
...
OUTPUT_DIR = PROJECT_ROOT / "data" / "validation" / "teg_gate_60day"

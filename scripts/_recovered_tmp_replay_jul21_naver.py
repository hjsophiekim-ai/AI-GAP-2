...
def fetch_naver_minutes(symbol: str, count: int = 500) -> pd.DataFrame:
    url = (
...
def main() -> int:
    ...
    hynix = fetch_naver_minutes("000660", 500)
    long_df = fetch_naver_minutes("0193T0", 500)
    inv_df = fetch_naver_minutes("0197X0", 500)
    ...
    # BEFORE: restore prior AND semantics for opposite transition only

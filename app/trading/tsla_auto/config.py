...
STRONG_FILTER_VERSION = "TSLA_STRONG_FLAG_V7_DEFAULT_OFF_20260804"
...
STRONG_FILTER_DEFAULT = _env_bool("TSLA_AUTO_STRONG_FILTER_DEFAULT", False)
...
QUICK_PROFIT_FILTER_DEFAULT = _env_bool("TSLA_AUTO_QUICK_PROFIT_FILTER_DEFAULT", False)
QUICK_PROFIT_TAKE_PROFIT_NET_PCT = _env_float("TSLA_AUTO_QUICK_PROFIT_TAKE_PROFIT_NET_PCT", 1.5)
